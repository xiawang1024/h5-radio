...
.six
    ...
    .weixin-wrap
        ...
        .scroll2
            ...
            width 981px
            height 40px
            background url('./scroll2.png') center center no-repeat
        .scroll3
            position absolute
            top 82px
            left 46px
            width 1365px
            height 49px
            background url('./scroll3.png') center center no-repeat
        .little-wrap
            position absolute
            top 0
            left 243px
            ...
            .antenna
                ...
                width 25px
                height 175px
                background url('./antenna.png') center center no-repeat
    .voice
        position absolute
        top 594px
        left 47px
    ...
    .pages
        ...
        width 152px
        height 154px
        background url('./pages.png') center center no-repeat
</style>
