...
.five
    ...
    .weibo-wrap
        ...
        .border1
            ...
            width 875px
            height 874px
            background url('./border1.png') center center no-repeat
        .border2
            position absolute
            top 83px
            left 84px
        ...
        .weibo
            ...
            .weibo-title
                ...
                width 256px
                height 48px
                background url('./weibo-title.png') center center no-repeat
            .weibo-desc
                position absolute
                top 353px
                left 2px
                width 252px
                height 28px
                background url('./weibo-desc.png') center center no-repeat
</style>
